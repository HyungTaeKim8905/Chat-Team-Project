...
<!-- 상단 네비바 -->
  <div class="topnav" id="myTopnav">
    <abbr title="회원 채팅">
      <a href="chatlist.jsp" <%if(URI.contains("chatlist")==true) {%>class="active"<%} %>>
...
%>
 <abbr title="회원가입">
    <a href="register.jsp" style="float: right;" <%if(URI.contains("register")==true) {%>class="active"<%} %>>
    ...
    <abbr title="로그인">
    <a href="login.jsp" style="float: right;" <%if(URI.contains("login")==true) {%>class="active"<%} %>>
...
%>
    <abbr title="마이페이지">
      <a href="mypageAction" style="float: right;" <%if(URI.contains("mypage")==true) {%>class="active"<%} %>>
